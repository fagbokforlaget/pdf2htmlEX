...
#ifndef CAIRO_IMAGES_RENDERER_H__
#define CAIRO_IMAGES_RENDERER_H__
...
class CairoImagesRenderer : public BackgroundRenderer, CairoImageOutputDev 
{
public:
  CairoImagesRenderer(HTMLRenderer * html_renderer, const Param & param);

  virtual ~CairoImagesRenderer();
  ...
  void writePageImage(char * filename);
...
#endif //CAIRO_IMAGES_RENDERER_H__
